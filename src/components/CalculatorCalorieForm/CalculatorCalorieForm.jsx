              ...
              <div className={styles.formWrapper}>
                ...
                <div className={styles.rightColumn}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <div role="group" aria-labelledby="blood-type-group" className={styles.radioGroup}>
                      {['1', '2', '3', '4'].map((type) => (
                        <label key={type} className={styles.radioLabel}>
                          ...
                          />
                          <span className={`${styles.radioCustom} ${values.bloodType === type ? styles.checked : ''}`}></span>
                          <span className={`${styles.radioText} ${values.bloodType === type ? styles.checkedText : ''}`}>
                            {type}
                          </span>
                        </label>
                      ))}
